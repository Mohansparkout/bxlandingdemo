...
!(function (e, t) {
              ...
              : function (e, t, n) {
                  ...
                  if (c) {
                    ...
                    if (((u = [m ? c.firstChild : c.lastChild]), m && d)) {
                      ...
                      while ((a = (++s && a && a[l]) || (p = s = 0) || u.pop()))
                        if ((b ? a.nodeName.toLowerCase() === f : 1 === a.nodeType) && ++p && (d && ((i = (o = a[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [A, p]), a === e)) break;
        ...
        for (l = a[a.length - 1].ownerDocument, E.map(a, Le), c = 0; c < s; c++)
          (u = a[c]),
            pe.test(u.type || "") &&
              ...
              E.contains(l, u) &&
              (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && !u.noModule && E._evalUrl(u.src, { nonce: u.nonce || u.getAttribute("nonce") }, l) : C(u.textContent.replace(Ne, ""), u, l));
    }
    return n;
  }
  function Oe(e, t, n) {
  ...
  function Fe(e, t, n) {
    ...
    return (
      (n = n || Ie(e)) &&
        ...
        !m.pixelBoxStyles() && Pe.test(a) && Be.test(t) && ((r = u.width), (i = u.minWidth), (o = u.maxWidth), (u.minWidth = u.maxWidth = u.width = a), (a = n.width), (u.width = r), (u.minWidth = i), (u.maxWidth = o))),
      void 0 !== a ? a + "" : a
    );
  }
  function $e(e, t) {
  ...
  function et(e, t, n) {
    ...
    return (
      ((!m.boxSizingReliable() && i) || (!m.reliableTrDimensions() && N(e, "tr")) || "auto" === a || (!parseFloat(a) && "inline" === E.css(e, "display", !1, r))) &&
